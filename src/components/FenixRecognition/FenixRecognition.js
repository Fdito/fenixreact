...
! function (e, n) {
    "function" == typeof define && define.amd ? define([], function () {
        return e.phoenix = n(e)
    }) : "object" === ("undefined" == typeof module ? "undefined" : _typeof(module)) && module.exports ? module.exports = n(e) : e.phoenix = n(e)
    ...
    var a, c, s = [],
        ...
        R = function (e, n, t) {
            s.push({
                ...
                callback: n,
                originalPhrase: t
            }), d && k("Comando añadido: %c" + t, p)
        },
        P = function (e) {
            var n;
            S(u.result, e);
            for (var t = 0; t < e.length; t++) {
                n = e[t].trim(), d && k("Voz reconocida: %c" + n, p);
                for (var o = 0, r = s.length; o < r; o++) {
                    var i = s[o],
                        a = i.command.exec(n);
                    if (a) {
                        var c = a.slice(1);
                        return d && (k("Comando ejecutado: %c" + i.originalPhrase, p), c.length && k("Parametros", c)), i.callback.apply(this, c), void S(u.resultMatch, n, i.originalPhrase, e)
                    }
                }
            }
            S(u.resultNoMatch, e)
    ...
    return t = {
        init: function (e) {
            ...
            a && a.abort && a.abort(), (a = new o).maxAlternatives = 5, a.continuous = "http:" === r.location.protocol, a.lang = "en-US", a.onstart = function () {
                ...
                if (m = !1, S(u.end), c) {
                    ...
                    (l += 1) % 10 == 0 && d, e < 1e3 ? setTimeout(function () {
                        t.start({
                            paused: g
                        })
                    }, 1e3 - e) : t.start({
                ...
                if (g) return d && k("Lo escuche, pero estoy en pausa"), !1;
                ...
                if (e.hasOwnProperty(o))
                    if ("function" == typeof (n = r[e[o]] || e[o])) R((t = (t = o).replace(w, "\\$&").replace(h, "(?:$1)?").replace(b, function (e, n) {
                        ...
                        if (!("object" === (void 0 === n ? "undefined" : _typeof(n)) && n.regexp instanceof RegExp)) {
                            d && k("Error no se puede añadir el comando: %c" + o, p);
                            continue
                        }
        ...
        trigger: function (e) {
            t.isListening() ? (Array.isArray(e) || (e = [e]), P(e)) : d && k(m ? "Speech heard, but phoenix is paused" : "Cannot trigger while phoenix is aborted")
        }
    }
});
